...
public class LivingEntity extends Entity implements Damageable {
    ...
    public double getAttribute(Attribute attribute){return living.getAttributeValue(attribute.nms());} public void addPotionEffect(PotionEffect effect){if(effect!=null)living.addEffect(effect.toNms());} public boolean addPotionEffect(PotionEffect effect, boolean force){addPotionEffect(effect);return true;}
