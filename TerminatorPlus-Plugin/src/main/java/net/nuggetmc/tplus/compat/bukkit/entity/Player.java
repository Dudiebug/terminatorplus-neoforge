...
public class Player extends HumanEntity implements CommandSender {
    ...
    public boolean isOnline(){return player.connection!=null;} public void openInventory(Inventory inventory){player.openMenu(new net.minecraft.world.SimpleMenuProvider((id,inv,p)->net.minecraft.world.inventory.ChestMenu.sixRows(id,inv),Component.literal(inventory.getTitle())));}
