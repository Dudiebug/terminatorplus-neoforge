...
public class World {
    ...
    public List<net.nuggetmc.tplus.compat.bukkit.entity.Entity> getEntities(){List<net.nuggetmc.tplus.compat.bukkit.entity.Entity> out=new ArrayList<>();for(Entity e:handle.getAllEntities())out.add(EntityBridge.wrap(e));return out;}
    public List<net.nuggetmc.tplus.compat.bukkit.entity.Entity> getNearbyEntities(Location location,double x,double y,double z){if(location==null)return List.of();BlockPos center=new BlockPos(location.getBlockX(),location.getBlockY(),location.getBlockZ());List<net.nuggetmc.tplus.compat.bukkit.entity.Entity> out=new ArrayList<>();for(Entity e:handle.getEntities(null,new net.minecraft.world.phys.AABB(center).inflate(x,y,z)))out.add(EntityBridge.wrap(e));return out;}
